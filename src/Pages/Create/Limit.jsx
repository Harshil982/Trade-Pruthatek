                ...
                <div className="row">
                  <div className="col-5">
                    ...
                    <ul className="list-group my-2">
                      <li className="list-group-item text-start text-muted">75</li>
                      <li className="list-group-item text-start text-muted">143.65</li>
                      <li className="list-group-item text-start text-muted">5.26</li>
                      <li className="list-group-item text-start text-muted">0.01</li>
                    </ul>
                  </div>
                  <div className="col-2">
                  ...
                  <div className="col-5">
                    ...
                    <ul className="list-group my-2">
                      <li className="list-group-item text-start text-muted">25</li>
                      <li className="list-group-item text-start text-muted">144.65</li>
                      <li className="list-group-item text-start text-muted">1.75</li>
                      <li className="list-group-item text-start text-muted">0.00</li>
                    </ul>
                  </div>
                </div>
              </div>
